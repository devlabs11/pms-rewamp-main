...
Route::controller(GstController::class)->group(function(){
    Route::get('gst', 'index');
    Route::get('gst-export', 'export')->name('gst.export')->middleware('can:export-tax');
});

Route::get('/tax-master-create' , function(){
    return view('admin.tax-master.tax-master-create');
})->middleware('can:create-tax-master');
Route::post('/tax-master-create', [App\Http\Controllers\GstController::class, 'storeGst'])->name('tax-master-create')->middleware('can:create-tax');
Route::get('/tax-master-show', [App\Http\Controllers\GstController::class, 'showGst'])->name('tax-master-show')->middleware('can:show-tax');
Route::get('/edit-tax-master/{id}' , [App\Http\Controllers\GstController::class, 'editGst'])->name('edit-tax-master')->middleware('can:edit-tax');
Route::post('/update-tax-master/{id}' , [App\Http\Controllers\GstController::class, 'updateGst'])->middleware('can:update-tax-master');
Route::get('/delete-tax-master/{id}' , [App\Http\Controllers\GstController::class, 'destroyGst'])->name('delete-tax-master')->middleware('can:delete-tax');
